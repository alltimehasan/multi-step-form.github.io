...
<body>
						...
						<form action="" id="regForm" style="background: #fdcb6e;">
							...
							<div class="tab step-two">
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio2" name="current_security_license" value="No" class="custom-control-input">
								...
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio4" name="armed_license" value="No" class="custom-control-input armed-custom-input">
								...
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio6" name="unarmed_license" value="No" class="custom-control-input unarmed-custom-input">
								...
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio7" name="years_18" value="Yes" class="custom-control-input">
								...
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio9" name="eligible_usa" value="Yes" class="custom-control-input">
								...
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio12" name="worked_school" value="No" class="custom-control-input custom-worked-school">
								...
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio14" name="worked_company" value="No" class="custom-control-input">
								...
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio16" name="crime" value="No" class="custom-control-input custom-crime-input">
									...
									<div class="form-group sr-only" id="crime_extra">
										...
										<textarea class="form-control" rows="4" id="crime_details"></textarea>
									</div>
								</div>
							</div>
							<!-- Step Two End -->
							...
							<div class="tab step-three">
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio17" name="desired_position" value="Full Time" class="custom-control-input">
										<label class="custom-control-label" for="customRadio17">Full Time</label>
									</div>
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio18" name="desired_position" value="Part Time" class="custom-control-input">
										<label class="custom-control-label" for="customRadio18">Part Time</label>
									</div>
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio19" name="desired_position" value="On Call" class="custom-control-input">
								...
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio20" name="unarmed_license" value="Yes" class="custom-control-input custom-previous-employer">
										<label class="custom-control-label" for="customRadio20">Yes</label>
									</div>
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio21" name="unarmed_license" value="No" class="custom-control-input custom-previous-employer">
									...
									<div class="form-row sr-only" id="previous_employer_extra">
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control" id="agreement_with">
										</div>
										<div class="form-group col-md-6">
											<label for="" class="main-label">For the duration of</label>
											<input type="text" class="form-control" id="agreement_duration">
										</div>
										<div class="form-group col-md-6">
											<label for="" class="main-label">Starting on</label>
											<input type="text" class="form-control" id="agreement_starting">
										</div>
										<div class="form-group col-md-6">
											<label for="" class="main-label">And ending on</label>
											<input type="text" class="form-control" id="agreement_ending">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="tab step-four">
								...
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio23" name="military_experience" value="No" class="custom-control-input">
								...
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio25" name="driver_license" value="No" class="custom-control-input">
								...
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio27" name="license_revoked" value="No" class="custom-control-input custom-license-suspend">
									...
									<div class="form-group sr-only" id="license_extra">
										...
										<textarea class="form-control" rows="4" id="license_suspend_details"></textarea>
									</div>
								</div>
							</div>
							<!-- Step Four End -->
							...
							<div class="tab step-five">
								...
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio29" name="may_contact_1" value="No" class="custom-control-input">
							...
							<div class="tab step-six">
								...
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio31" name="may_contact_2" value="No" class="custom-control-input">
							...
							<div class="tab step-seven">
								...
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio33" name="may_contact_3" value="No" class="custom-control-input">
							...
							<div class="tab step-eight">
								<div class="form-group">
									<label for="" class="main-label">Graduated from (check all that apply)</label>
									<div class="custom-control custom-checkbox">
										<input type="checkbox" id="customCheckbox8" name="agreement" value="Agreements" class="custom-control-input">
								...
								<div class="form-row mb-5">
									<div class="form-group col-md-6">
										<label for="" class="main-label">Applicant Digital Signature (Type Your Full Legal Name)<span>*</span></label>
										<div id="signature-pad" class="signature-pad">
											<div class="signature-pad--body">
												<canvas></canvas>
												<button type="button" class="btn my-btn button clear" data-action="clear">Clear</button>
											</div>
										</div>
										<input type="hidden" id="signature" name="signature">
										<input type="hidden" name="emptyChecking" id="emptyChecking" value="0">
									</div>
								</div>
								<!-- <div class="text-right">
									<button type="submit" class="btn my-btn">Send Application</button>
								</div> -->
							</div>
							<!-- Step Eight End -->
	...
	<!-- All JS Plugins -->
	<script src="{{asset('frontend/js/signature_pad.umd.js')}}"></script>
