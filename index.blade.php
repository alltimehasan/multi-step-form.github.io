						...
						<form action="" id="regForm" style="background: #fdcb6e;">
							...
							<div class="tab step-two">
								...
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										...
										<label class="custom-control-label" for="customRadio6" checked>No</label>
									</div>
							...
							<div class="tab step-three">
								...
								<div class="form-group">
									...
									<div class="custom-control custom-radio">
										<input type="radio" id="customRadio21" name="non_compete" value="No" class="custom-control-input custom-previous-employer">
							...
							<div class="tab step-eight">
								...
								<div class="form-group">
									...
									<input type="text" name="todays_date" class="form-control required" required>
								</div>
									...
									<div class="form-group col-md-6">
										...
										<div id="signature-pad" class="signature-pad">
											<div class="signature-pad--body">
												<canvas width="386" height="185"></canvas>
